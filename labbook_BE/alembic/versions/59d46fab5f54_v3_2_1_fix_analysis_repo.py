...
def upgrade():
    ...
    try:
        conn.execute(text("update sigl_07_data set normal_min='2.15' "
    ...
    try:
        conn.execute(text("alter table sigl_05_data drop column paillasse"))
    except Exception as err:
        print("ERROR drop column paillasse to sigl_05_data,\n\terr=" + str(err))

    # DROP COLUMN TO Patient TABLE
    try:
        conn.execute(text("alter table sigl_03_data drop column ethnie"))
    except Exception as err:
        print("ERROR drop column ethnie to sigl_03_data,\n\terr=" + str(err))

    # DROP COLUMN TO Patient TABLE
    try:
        conn.execute(text("alter table sigl_03_data drop column annee_naiss"))
    except Exception as err:
        print("ERROR drop column annee_naiss to sigl_03_data,\n\terr=" + str(err))

    # DROP COLUMN TO Patient TABLE
    try:
        conn.execute(text("alter table sigl_03_data drop column mois_naiss"))
    except Exception as err:
        print("ERROR drop column mois_naiss to sigl_03_data,\n\terr=" + str(err))

    # DROP COLUMN TO Patient TABLE
    try:
        conn.execute(text("alter table sigl_03_data drop column semaine_naiss"))
    except Exception as err:
    ...
    # New user type
    try:
        conn.execute(text("alter table sigl_pj_role add column type varchar(10)"))
    except Exception as err:
        print("ERROR add column type to sigl_pj_role,\n\terr=" + str(err))

    try:
        conn.execute(text("update sigl_pj_role set type='A' where name='admin'"))
    except Exception as err:
        print("ERROR update sigl_pj_role set type='A' where name='admin',\n\terr=" + str(err))

    try:
        conn.execute(text("update sigl_pj_role set type='B' where name='biologiste'"))
    except Exception as err:
        print("ERROR update sigl_pj_role set type='B' where name='biologiste',\n\terr=" + str(err))

    try:
        conn.execute(text("update sigl_pj_role set type='T' where name='technicien'"))
    except Exception as err:
        print("ERROR update sigl_pj_role set type='T' where name='technicien',\n\terr=" + str(err))

    try:
        conn.execute(text("update sigl_pj_role set type='S' where name='secretaire'"))
    except Exception as err:
        print("ERROR update sigl_pj_role set type='S' where name='secretaire',\n\terr=" + str(err))

    try:
        conn.execute(text("update sigl_pj_role set type='TA' where name='technicien avance'"))
    except Exception as err:
        print("ERROR update sigl_pj_role set type='TA' where name='technicien avance',\n\terr=" + str(err))

    try:
        conn.execute(text("update sigl_pj_role set type='TQ' where name='technicien qualiticien'"))
    except Exception as err:
        print("ERROR update sigl_pj_role set type='TQ' where name='technicien qualiticien',\n\terr=" + str(err))

    try:
        conn.execute(text("update sigl_pj_role set type='SA' where name='secretaire avancee'"))
    except Exception as err:
        print("ERROR update sigl_pj_role set type='SA' where name='secretaire avancee',\n\terr=" + str(err))

    try:
        conn.execute(text("update sigl_pj_role set type='Q' where name='qualiticien'"))
    except Exception as err:
        print("ERROR update sigl_pj_role set type='Q' where name='qualiticien',\n\terr=" + str(err))

    try:
        conn.execute(text("update sigl_pj_role set type='P' where name='prescripteur'"))
    except Exception as err:
        print("ERROR update sigl_pj_role set type='P' where name='prescripteur',\n\terr=" + str(err))

    try:
        conn.execute(text("alter table sigl_user_data add column role_type varchar(10)"))
    except Exception as err:
    ...
    try:
        conn.execute(text("drop table sigl_pj_group_link, sigl_pj_group"))
    except Exception as err:
        print("ERROR drop table sigl_pj_group_link, sigl_pj_group,\n\terr=" + str(err))

    # update syntax of one role label
    try:
        conn.execute(text("update sigl_pj_role set label='Secrétaire avancée' where type='SA'"))
    except Exception as err:
        print("ERROR update sigl_pj_role set label='Secrétaire avancée' where type='SA',\n\terr=" + str(err))

    # UPDATE firstname for root user
    try:
        conn.execute(text("update sigl_user_data set firstname='' where username='root'"))
    except Exception as err:

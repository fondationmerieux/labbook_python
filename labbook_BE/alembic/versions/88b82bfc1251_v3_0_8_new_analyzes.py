...
def upgrade():
    ...
    try:
        conn.execute('insert into sigl_07_data (id_owner, libelle, type_resultat, commentaire) '
        ...
        conn.execute('update sigl_07_data set code_var=id_data where libelle="Recherche du bacille de l\'anthrax par PCR" limit 1')
        ...
        try:
            ...
            try:
                ...
                conn.execute('insert into sigl_05_07_data (id_owner, id_refanalyse, id_refvariable, position, '
    ...
    try:
        ...
        conn.execute('update sigl_07_data set code_var=id_data where libelle="Détection de l\'ARN du virus de la Dengue '
                     'par RT-PCR" limit 1')
    except Exception as err:
    ...
    try:
        ...
        conn.execute('update sigl_07_data set code_var=id_data where libelle="Détection de l\'antigène NS1 de la Dengue" limit 1')
    except Exception as err:
    ...
    try:
        ...
        conn.execute('update sigl_07_data set code_var=id_data where libelle="Recherche des Ac contre la Dengue" limit 1')
    except Exception as err:
    ...
    try:
        ...
        conn.execute('update sigl_07_data set code_var=id_data where libelle="Recherche des Ac IgG et IgM anti rage" limit 1')
    except Exception as err:
    ...
    try:
        ...
        conn.execute('update sigl_07_data set code_var=id_data where libelle="Recherche génome du virus de la rage" limit 1')
    except Exception as err:
    ...
    try:
        ...
        conn.execute('update sigl_07_data set code_var=id_data where libelle="Détection du génome des virus Influenza A et B de la grippe" limit 1')
    except Exception as err:
    ...
    try:
        ...
        conn.execute('update sigl_07_data set code_var=id_data where libelle="Détection virus Ebola par test rapide Oraquick" limit 1')
    except Exception as err:

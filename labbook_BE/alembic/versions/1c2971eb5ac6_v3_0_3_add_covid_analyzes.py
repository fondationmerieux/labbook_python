...
def upgrade():
    ...
    try:
        conn.execute("alter table sigl_07_data change `precision` accuracy int(1) unsigned")
    except:
        print("ERROR alter table sigl_07_data change `precision` accuracy int(1) unsigned")

    # MODIFY COLUMN TO ANALYSIS TABLE
    try:
        conn.execute("alter table sigl_05_data modify column code varchar(7)")
    except:
    ...
    try:
        conn.execute("alter table sigl_05_data add column ana_whonet int(1) default 5")
    except:
        ...
        try:
            ...
            conn.execute('update sigl_05_data set ana_whonet=5')
        except:
        ...
        try:
            ...
            conn.execute('update sigl_05_data set ana_whonet=4 '
    ...
    try:
        ...
        conn.execute('insert into sigl_07_data (id_owner, libelle, type_resultat, normal_min, normal_max, accuracy, unite) '
        ...
        conn.execute('insert into sigl_07_data (id_owner, libelle, type_resultat, accuracy) '
    ...
    try:
        ...
        conn.execute('update sigl_07_data set formule="$1 / $3 * 100" where id_data=182 and formule="($1 + $2) * 100 / $3"')
    except:
    ...
    try:
        ...
        conn.execute('update sigl_15_data set formule="$_284" where id_data=68 and formule="$_182 > 1000"')
    except:
    ...
    try:
        ...
        conn.execute('update sigl_15_data set formule="$_316 != [posnegind.Positif]" where id_data=44 and '
    ...
    try:
        ...
        conn.execute('update sigl_15_data set formule="$_316 = [posnegind.Positif]" where id_data=45 and '

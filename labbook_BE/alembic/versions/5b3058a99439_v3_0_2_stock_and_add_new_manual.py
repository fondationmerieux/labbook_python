...
def upgrade():
    ...
    try:
        ...
        conn.execute(text("alter table backup_setting drop column bks_pwd"))
    except Exception as err:
    ...
    try:
        ...
        conn.execute(text("alter table product_details add column prd_safe_limit int default 0"))
    except Exception as err:
    ...
    try:
        ...
        conn.execute(text("alter table product_supply add column prs_user int default 0"))
    except Exception as err:
    ...
    try:
        ...
        conn.execute(text("alter table product_supply drop column prs_status"))
    except Exception as err:
    ...
    try:
        ...
        conn.execute(text("alter table product_supply drop column prs_sell_price"))
    except Exception as err:
    ...
    try:
        ...
        conn.execute(text("alter table product_supply add column prs_empty varchar(1) not null default 'N'"))
    except Exception as err:
    ...
    try:
        conn.execute(text("delete from sigl_storage_data"))
    except Exception as err:
    ...
    # DELETE OLD MANUALS
    try:
        conn.execute(text("delete from sigl_manuels_data where id_data in (5,6,10,11)"))
    except Exception as err:
        print("ERROR delete from sigl_manuels_data where id_data in (5,6,10,11),\n\terr=" + str(err))

    try:
        conn.execute(text("delete from sigl_manuels_document__file_data where id_ext in (5,6,10,11)"))
    except Exception as err:
        print("ERROR delete from sigl_manuels_document__file_data where id_ext in (5,6,10,11),\n\terr=" + str(err))

    try:
        conn.execute(text("delete from sigl_file_data where id_data in (5,7,12,13)"))
    except Exception as err:

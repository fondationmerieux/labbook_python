...
def upgrade():
    ...
    try:
        ...
        conn.execute(text("create table age_interval_setting("
        ...
        try:
            ...
            conn.execute(text("insert into age_interval_setting (ais_rank, ais_upper_bound) values (0, 5)"))
            conn.execute(text("insert into age_interval_setting (ais_rank, ais_lower_bound, ais_upper_bound) values (1, 5, 20)"))
            conn.execute(text("insert into age_interval_setting (ais_rank, ais_lower_bound, ais_upper_bound) values (2, 20, 40)"))
            conn.execute(text("insert into age_interval_setting (ais_rank, ais_lower_bound) values (3, 40)"))
        except Exception as err:
    ...
    try:
        ...
        conn.execute(text("create table sticker_setting("
        ...
        try:
            ...
            conn.execute(text("insert into sticker_setting "
    ...
    try:
        ...
        conn.execute(text("create table backup_setting("
        ...
        try:
            ...
            conn.execute(text("insert into backup_setting (bks_start_time) values ('12:00:00')"))
        except Exception as err:
    ...
    try:
        ...
        conn.execute(text("update sigl_file_data set id_storage=1 where id_storage is null"))
    except Exception as err:
    ...
    try:
        ...
        conn.execute(text("update sigl_manuels_data"
    ...
    try:
        ...
        conn.execute(text("create table product_details("
    ...
    try:
        ...
        conn.execute(text("create table product_supply("
    ...
    try:
        ...
        conn.execute(text("create table product_use("
    ...
    # ADD NEW USER ROLE
    try:
        conn.execute(text("insert into sigl_pj_role "
                     "(name, label) "

...
def upgrade():
    ...
    try:
        ...
        conn.execute(text("insert into sigl_07_data (id_owner, libelle, type_resultat) values (1000, 'B-lactamase', 600)"))

        # Insert inhibition diameter var
        conn.execute(text("insert into sigl_07_data (id_owner, libelle, unite, type_resultat) \
        ...
        try:
            conn.execute(text("insert into sigl_05_data (id_owner, code, nom, abbr, famille, cote_unite, commentaire, actif) \

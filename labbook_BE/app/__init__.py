...
api.add_resource(ConformityList,      '/services/quality/conformity/list')
api.add_resource(ConformityDet,       '/services/quality/conformity/det/<int:id_item>')
api.add_resource(ConformityExport,    '/services/quality/conformity/export')

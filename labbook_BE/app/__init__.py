...
from app.services.AuditRest import *
...
api.add_resource(AnalysisDetFromExt,    '/services/external/analysis/det/<int:id_ana>')
...
api.add_resource(AnalysisListFromExt,   '/services/external/analysis/list')
...
api.add_resource(AuditList,             '/services/audit/list')
api.add_resource(AuditDet,              '/services/audit/det/<int:aud_ser>')
api.add_resource(AuditCreate,           '/services/audit/create')
api.add_resource(AuditExportATNA,       '/services/audit/export-atna')
api.add_resource(AuditDownloadATNA,     '/services/audit/export-atna-download/<string:filename>')
api.add_resource(AuditArchiveDownload,  '/services/audit/archive-download/<string:filename>')
api.add_resource(AuditArchive,          '/services/audit/archive')
...
api.add_resource(ConnectSetting,        '/services/connect/setting')
...
api.add_resource(EquipmentComm,         '/services/quality/equipment/comm/<string:type>/<int:id_eqp>')
...
api.add_resource(EqpDoc,                '/services/quality/equipment/doc/<string:type>/<int:id_eqp>', '/services/quality/equipment/doc/<int:id_eqp>')
api.add_resource(EqpFailureList,        '/services/quality/equipment/failure/list/<int:id_eqp>')
api.add_resource(EqpFailureExport,      '/services/quality/equipment/failure/export/<int:id_eqp>')
api.add_resource(EqpFailureDet,         '/services/quality/equipment/failure/det/<int:id_item>')
api.add_resource(EqpMetrologyList,      '/services/quality/equipment/metrology/list/<int:id_eqp>')
api.add_resource(EqpMetrologyExport,    '/services/quality/equipment/metrology/export/<int:id_eqp>')
api.add_resource(EqpMetrologyDet,       '/services/quality/equipment/metrology/det/<int:id_item>')
api.add_resource(EqpPreventList,        '/services/quality/equipment/preventive/list/<int:id_eqp>')
api.add_resource(EqpPreventExport,      '/services/quality/equipment/preventive/export/<int:id_eqp>')
api.add_resource(EqpPreventiveDet,      '/services/quality/equipment/preventive/det/<int:id_item>')
api.add_resource(EqpContractList,       '/services/quality/equipment/contract/list/<int:id_eqp>')
api.add_resource(EqpContractExport,     '/services/quality/equipment/contract/export/<int:id_eqp>')
api.add_resource(EqpContractDet,        '/services/quality/equipment/contract/det/<int:id_item>')
...
api.add_resource(MessageList,           '/services/quality/message/list/<int:id_user>')
api.add_resource(MessageDet,            '/services/quality/message/det/<int:id_item>')
api.add_resource(MessageDel,            '/services/quality/message/del/<int:id_item>/<int:id_user>')
api.add_resource(MessageRead,           '/services/quality/message/read/<int:id_item>')
api.add_resource(MessageUnread,         '/services/quality/message/unread/<int:id_user>')
...
api.add_resource(PatientHistFormItem,   '/services/patient/history/form/item/<int:id_pat>', '/services/patient/history/form/item/<int:id_pat>/<string:evt_id>')
...
api.add_resource(PdfInvoice,            '/services/pdf/invoice/<int:id_rec>/<string:template>/<string:filename>')
...
api.add_resource(RecordNumInt,          '/services/record/search/num/int/<string:rec_num_int>')
api.add_resource(RecordValid,           '/services/record/valid/<int:id_rec>')
...
api.add_resource(ReportTAT,             '/services/report/tat')
...
api.add_resource(ResultPrevious,        '/services/result/previous')
...
api.add_resource(ResultFromExt,         '/services/external/result/<int:id_rec>')
api.add_resource(SettingAgeInterval,    '/services/setting/age/interval')
api.add_resource(SettingBackup,         '/services/setting/backup')
api.add_resource(SettingDHIS2Det,       '/services/setting/dhis2/api/det/<int:id_item>')
api.add_resource(SettingDHIS2List,      '/services/setting/dhis2/api/list')
...
api.add_resource(SettingSendMethodList, '/services/setting/sending/method/list')
api.add_resource(SettingSendMethodDet,  '/services/setting/sending/method/det/<string:type>/<int:id_item>')
api.add_resource(SettingSendMethodTest, '/services/setting/sending/method/test/<string:type>/<int:id_item>')
api.add_resource(SettingSendModelList,  '/services/setting/sending/model/list')
api.add_resource(SettingSendModelDet,   '/services/setting/sending/model/det/<string:type>/<int:id_item>')
api.add_resource(SettingSendModelTest,  '/services/setting/sending/model/test/<string:type>/<int:mdl_ser>')
api.add_resource(SettingSendReport,     '/services/setting/sending/report')
api.add_resource(SettingSendResend,     '/services/setting/sending/resend/<int:sde_ser>')
api.add_resource(SettingSendList,       '/services/setting/sending/list')
...
api.add_resource(StorageList,           '/services/quality/storage/list')
api.add_resource(StorageRoomList,       '/services/quality/storage/room/list')
api.add_resource(StorageRoomDet,        '/services/quality/storage/room/det/<int:id_item>')
api.add_resource(StorageChamberList,    '/services/quality/storage/chamber/list')
api.add_resource(StorageChamberDet,     '/services/quality/storage/chamber/det/<int:id_item>')
api.add_resource(StorageCompList,       '/services/quality/storage/compartment/list')
